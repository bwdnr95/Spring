...
/*
 ...
 저장된 com.kosmo.k11springlegacy를 스캔하여 컨트롤러 클래스를
...
@RequestMapping
	:요청명을 매핑한다. 요청명은 서블릿과 마찬가지로 컨택스트 루트를
...
public class FormController {
	...
	/*
 	...
 	조건2 : 커맨드객체를 사용해야할때는 클래스명 앞글자를 소문자로 바꾼
 		형태의 매개변수를 사용해야 한다.
	...
	/*
	 ...
	 주의해야 한다. 또한 파라미터의 갯수가 틀려지면 404에러가 발생한다.
	 */
